...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[0] = LAYOUT_planck_1x2uC(KC_ESC, KC_Q, KC_D, KC_R, KC_W, KC_B, KC_J, KC_F, KC_U, KC_P, KC_SCLN, KC_BSPC, KC_TAB, KC_A, KC_S, KC_H, KC_T, KC_G, KC_Y, KC_N, KC_E, KC_O, KC_I, KC_QUOT, KC_LSFT, KC_Z, KC_X, KC_M, KC_C, KC_V, KC_K, KC_L, KC_COMM, KC_DOT, KC_SLSH, KC_SFTENT, KC_LCTL, C_S_T(KC_DEL), KC_LGUI, KC_LALT, MO(3), KC_SPC, MO(4), KC_LEFT, KC_DOWN, KC_UP, RCTL_T(KC_RGHT)),
	[1] = LAYOUT_planck_1x2uC(KC_ESC, KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_I, KC_O, KC_BSPC, KC_TAB, KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, KC_SCLN, KC_QUOT, KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_SFTENT, KC_LCTL, C_S_T(KC_APP), KC_LGUI, KC_LALT, MO(3), KC_SPC, MO(4), KC_LEFT, KC_DOWN, KC_UP, RCTL_T(KC_RGHT)),
	[2] = LAYOUT_planck_1x2uC(KC_ESC, KC_Q, KC_W, KC_F, KC_P, KC_B, KC_J, KC_L, KC_U, KC_Y, KC_SCLN, KC_BSPC, KC_TAB, KC_A, KC_R, KC_S, KC_T, KC_G, KC_M, KC_N, KC_E, KC_I, KC_O, KC_QUOT, KC_LSFT, KC_Z, KC_X, KC_C, KC_D, KC_V, KC_K, KC_H, KC_COMM, KC_DOT, KC_SLSH, KC_SFTENT, KC_LCTL, C_S_T(KC_APP), KC_LGUI, KC_LALT, MO(3), KC_SPC, MO(4), KC_LEFT, KC_DOWN, KC_UP, RCTL_T(KC_RGHT)),
